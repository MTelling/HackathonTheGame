...
export default class Game extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            width: "100",
            challenge: {
                name: "No Challenge Loaded Yet!",
                description: "No Description Yet!",
                initialCode: "No Initial Code Received Yet!",
            },
            user:{
                open: false,
                username: "Anonymous",
            ...
            submitting: false,
            code: "",
            output: "When you click submit, the output will appear here.",
    ...
    handleClose() {
        ...
        // Move the tab to the description.
        this.setState({
            activeTab: "description",
        });
    }
    ...
    render() {
        ...
        return (
            <div className="gameContainer" style={{width: this.state.width + "%"}}>
                ...
                <Paper className="editorContainer" zDepth={2} rounded={false}>
                    <Editor
                ...
                <form onSubmit={this.handleSubmitCode}>
                    <RaisedButton
                        ...
                        className="submitCodeBtn"
                        disabled={this.state.submitting}/>
                </form>

                <RaisedButton
                    label="Reset"
                    className="resetCodeBtn"
